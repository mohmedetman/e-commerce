                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.edit.sittings')}}"
                                              method="POST"
                                              enctype="multipart/form-data">
                                            <input type="hidden"  value="{{$type_shipping->id}}" id="latitude" name="setting_id">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 ">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" 
                                                                   class="form-control" 
                                                                   value="{{$type_shipping->plain_value}}"
